...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default='the_best_for_object.pt', help='initial weights path')
    parser.add_argument('--cfg', type=str, default='working/new_train_yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='working/new_data_yaml', help='dataset.yaml path')
    ...
    parser.add_argument('--name', default='peet', help='save to project/name')
